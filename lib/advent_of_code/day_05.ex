defmodule AdventOfCode.Day05 do
  ...
  def split_range(ms..me = mapper, rs..re) when ms > rs and me < re,
    do: {[mapper], [rs..(ms - 1), (me + 1)..re]}

  def split_range(ms..me, rs..re) when ms <= rs and me >= rs and me < re,
    do: {[rs..me], [(me + 1)..re]}

  def split_range(ms..me, rs..re) when ms > rs and ms <= re and me >= re,
    do: {[ms..re], [rs..(ms - 1)]}
